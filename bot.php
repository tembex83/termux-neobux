...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://www.neobux.com/m/v/?vl=DD049E0803A5A36F");
...
echo" $green2 ======> Your coin = $blue $balance[0]    \n";
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://www.neobux.com/m/v/?vl=DD049E0803A5A36F=$token[0]");
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_HTTPHEADER, $header);
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
